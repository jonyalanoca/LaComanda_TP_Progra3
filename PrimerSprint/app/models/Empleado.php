<?php
    ...
    class Empleado extends Personal{
        ...
        public function  crearPersonal(){
            ...
            $consulta = $objAccesoDatos->prepararConsulta("INSERT INTO empleados (nombre, apellido, edad, dni, email, clave, seccion, sueldo, fechaIngreso, fechaEgreso) VALUES (:nombre, :apellido, :edad, :dni, :email, :clave, :seccion, :sueldo, :fechaIngreso, :fechaEgreso)");
        ...
        public static function modificarPersonal($personal){
            ...
            $consulta = $objAccesoDato->prepararConsulta("UPDATE empleados SET nombre=:nombre, apellido=:apellido, edad=:edad, dni=:dni, email=:email, clave=:clave, seccion=:seccion, sueldo=:sueldo, fechaIngreso=:fechaIngreso, fechaEgreso=:fechaEgreso WHERE idEmpleado = :id");
