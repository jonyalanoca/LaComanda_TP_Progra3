<?php
    class Producto{
        ...
        public function  crearProductoConId(){
            $objAccesoDatos = AccesoDatos::obtenerInstancia();
            $consulta = $objAccesoDatos->prepararConsulta("INSERT INTO productos (idProducto,nombre,precio,stock,seccion,tiempoPreparacion,descripcion) VALUES (:idProducto, :nombre, :precio, :stock, :seccion, :tiempoPreparacion, :descripcion)");
