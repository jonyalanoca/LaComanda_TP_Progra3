<?php
  ...
  $app->group('/productos', function (RouteCollectorProxy $group) {
    ...
    $group->post('/backup/exportar/', \ProductoController::class . ':GuardarDatosEnCsv');
    $group->post('/backup/importar/', \ProductoController::class . ':CargarDatosDesdeCsv');
  ...
  $app->group('/empleados', function (RouteCollectorProxy $group) {
    ...
    $group->put('/estado/{id}', \EmpleadoController::class . ':ModificarEstado')->add(\Verificadora::class . ':VerificarParamEmpleadoEstado');
  ...
  $app->group('/comandas', function (RouteCollectorProxy $group) {
    ...
    $group->put('/cobrar/{id}', \ComandaController::class . ':Cobrar')->add(\AutentificadoraLogin::class . ':VerificarSocio');
  ...
  $app->group('/ordenes', function (RouteCollectorProxy $group) {
    ...
    $group->get('/fallidas/', \OrdenController::class . ':ObtenerFallidos')->add(\AutentificadoraLogin::class . ':VerificarSocio');
    $group->get('/informe/', \OrdenController::class . ':ObtenerInforme')->add(\AutentificadoraLogin::class . ':VerificarSocio');
